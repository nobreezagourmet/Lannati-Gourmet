...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="features" className="relative pt-24 md:pt-40 pb-20 md:pb-28 bg-bordeaux z-10 scroll-mt-20 overflow-visible">
      ...
      <div className="absolute top-[100%] left-0 w-full overflow-hidden leading-none z-50 -mt-[1px]">
        <svg 
          ...
          className="relative block w-[101.5%] h-[60px] md:h-[100px] text-bordeaux fill-current will-change-transform"
