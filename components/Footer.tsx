      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
            ...
            <p className="font-body-standard text-cream/40 text-[10px] tracking-[0.3em] uppercase font-bold">Redes Sociais:</p>
            <div className="flex gap-4">
              <a href="https://www.instagram.com/lannattigourmet/" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-gold/5 text-gold/60 rounded-full hover:bg-gold hover:text-bordeaux hover:scale-110 transition-all duration-300">
                <Instagram size={18} />
              </a>
              <a href="https://www.facebook.com/people/Lannati-Gourmet/61584220003845/" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-gold/5 text-gold/60 rounded-full hover:bg-gold hover:text-bordeaux hover:scale-110 transition-all duration-300">
                <Facebook size={18} />
              </a>
            </div>
          </div>
