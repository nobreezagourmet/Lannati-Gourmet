...
const HistorySection: React.FC = () => {
  return (
    <section id="history" className="relative pt-32 pb-40 md:pt-48 md:pb-64 bg-bordeaux text-cream z-10 scroll-mt-20">
      ...
      {/* ONDA SUPERIOR: Ajuste para evitar fendas e garantir que o bordeaux cubra o gold corretamente */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-12 md:gap-32 max-w-7xl mx-auto">
          <div className="w-full md:w-1/2 text-left space-y-6 md:space-y-12">
            ...
            <p className="font-body-standard text-base md:text-2xl text-cream/60 leading-relaxed font-light w-full text-justify md:text-left [hyphens:auto]">
      ...
      {/* ONDA INFERIOR: Ajuste de sobreposição milimétrica para evitar a fenda clara */}
