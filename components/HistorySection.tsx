...
const HistorySection: React.FC = () => {
  return (
    <section id="history" className="relative pt-40 pb-48 md:pb-64 bg-bordeaux text-cream z-10 scroll-mt-20">
      
      {/* ONDA SUPERIOR: GEOMETRIA CORRIGIDA 100% WIDTH */}
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none z-50 -translate-y-[99.8%]">
        <svg 
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-16 md:gap-32 max-w-7xl mx-auto">
          ...
          <div className="w-full md:w-1/2 rounded-[3rem] md:rounded-[4rem] overflow-hidden">
            <img 
      ...
      {/* ONDA INFERIOR: GEOMETRIA CORRIGIDA 100% WIDTH */}
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-50 translate-y-[99.8%]">
        <svg 
          viewBox="0 0 1200 120" 
          preserveAspectRatio="none" 
          className="relative block w-[101%] h-[100px] md:h-[180px] text-bordeaux fill-current"
